...
def get_args():
    ...
    parser.add_argument('--config_file', type=str, default='config/maestro-20230721.yaml',  # todo
                        help='path of config file')
    parser.add_argument('--name', type=str, default='maestro-20230721',  # todo
...
def main_worker(local_rank, args):
    ...
    args.log_frequency = config['solver']['sample_iterations']
    if args.debug:
