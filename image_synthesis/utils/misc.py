...
def modify_config_for_debug(config):
    ...
    if 'n_sample' in config['dataloader']['train_datasets'][0]['params'].keys():
        config['dataloader']['train_datasets'][0]['params']['n_sample'] = 10
    config['solver']['sample_iterations'] = 1
    config['model']['params']['diffusion_config']['params']['transformer_config']['params']['n_layer'] = 2
    return config
